<%@ Page Title="" Language="C#" MasterPageFile="~/Layouts/Navbar.Master" AutoEventWireup="true" CodeBehind="UpdateMakeupBrand.aspx.cs" Inherits="MakeUpzz.Views.UpdateMakeupBrand" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-container">
        ...
        <div class="form-group">
            <asp:Label ID="LblRating" CssClass="label" runat="server" Text="Rating"></asp:Label>
