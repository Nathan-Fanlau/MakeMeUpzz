<%@ Page Title="" Language="C#" MasterPageFile="~/Layouts/Navbar.Master" AutoEventWireup="true" CodeBehind="UpdateMakeupType.aspx.cs" Inherits="MakeUpzz.Views.UpdateMakeupType" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-container">
        ...
        <div>
            ...
            <asp:Button ID="backBtn" runat="server" CssClass="button" Text="Back" OnClick="backBtn_Click" />
        </div>
